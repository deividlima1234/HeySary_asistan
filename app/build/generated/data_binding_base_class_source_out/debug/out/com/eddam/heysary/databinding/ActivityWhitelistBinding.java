...
public final class ActivityWhitelistBinding implements ViewBinding {
  ...
  private ActivityWhitelistBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView appsRecycler, @NonNull View backgroundGradient,
      @NonNull BottomNavigationView bottomNav, @NonNull ProgressBar loadingBar,
  ...
  public static ActivityWhitelistBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityWhitelistBinding((ConstraintLayout) rootView, appsRecycler,
          backgroundGradient, bottomNav, loadingBar, subtitleText, titleText);
    }
